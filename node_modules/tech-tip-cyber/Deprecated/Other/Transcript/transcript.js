// async function fetchMessage(message, numberOfMessages) {
//     if (!message) throw new ReferenceError('"message" Is Not Defined, Join https://discord.gg/2FMvpaUcWh For Help')
//     if (!numberOfMessages) throw new ReferenceError('"numberOfMessages" Is Not Defined, Join https://discord.gg/2FMvpaUcWh For Help')
//     if (typeof numberOfMessages !== "number") throw new SyntaxError('"numberOfMessages" Must Be Nubmer, Join https://discord.gg/2FMvpaUcWh For Help')
//     if (numberOfMessages >= 100) throw new RangeError('"numberOfMessages" Can\'t Be More Than 100 For Now, Join https://discord.gg/2FMvpaUcWh For Help')
...
//                     messagecount.appendChild(document.createTextNode(`Fetched Messages:`))
